...
NGame = {
	...
	MAX_ESTATE_COUNTRIES = 100,				-- Max is 100
	MAX_FEDERATION_COUNTRIES = 100,			-- Max is 100
...
NDiplomacy = {
	...
	AE_OTHER_CONTINENT = 0,
	AE_SAME_CULTURE = 0.05,
	AE_SAME_CULTURE_GROUP = 0.10,
	AE_INFIDEL_CONQUEST = 0, 		-- different religion group conquered same religion province
	AE_SAME_RELIGION = 0.10,
	AE_SAME_RELIGION_GROUP = 0.15,
	...
	AE_DISTANCE_BASE = 0.10, --0.75 per 100 distance
	...
	PO_FORM_PU_AE = 0, 							-- _DDEF_PO_FORM_PU_AE = 10, (Per development)
	...
	PEACE_COST_JOIN_HRE = 10, 							-- Max Peace cost for forcing country to join the empire
	...
	PEACE_COST_CHANGE_HRE_RELIGION = 25,
	...
	DIPLOMAT_SPEED = 200.0,							-- DIPLOMAT_SPEED
...
NCountry = {
	...
	ABDICATE_AGE_THRESHOLD = 1,
	ABDICATE_RULING_LENGTH_THRESHOLD = 1,
	ABDICATE_LEGITIMACY_HIT = 0,
	ABDICATE_PRESTIGE_HIT = 0,


	DISINHERIT_PRESTIGE_HIT = 0,
	...
	MIN_DEV_FOR_FREE_CITY = 0,					-- Capital must have at least this much development to be a free city
	...
	HRE_INCIDENT_MEMBER_SUPPORT_IA = 1,	-- How much worth an elector support is in an incident
	...
	MAX_ACTIVE_POLICIES = 15,						-- how many active policies at once.
	MINIMUM_POLICY_TIME = 10,						-- how many years minimum for a policy
	POLICY_COST = 1,								-- Monthly cost per policy
	BASE_POSSIBLE_POLICIES = 6,						-- How many policies in a category a nation can have as a base
	...
	DISMANTLE_HRE_PRESTIGE = 200,						-- Prestige gain on dismantling HRE
	...
	CLAIM_LOSE = 999999,								-- how many years until a claim is lost.
	CORE_LOSE = 999999, 								-- how many years until a core is lost.
	CORE_LOSE_CULTURE_GROUP = 999999,					-- how many years until a core in a country's culture group is lost.
	...
	LAGGINGTECH_CORRUPTION = -0.5,					-- Corruption increase/year. Multiplied by (highest - lowest) tech level
	LAGGINGTECH_CORRUPTION_MAX = -1.0,				-- Max increase/year
	...
	AGE_OF_ADULTHOOD = 5, 							-- _CDEF_AGE_OF_ADULTHOOD_
	MAX_QUEEN_AGE = 35,								-- You can't get a queen/prince older than this
	MAX_EXTRA_PERSONALITIES = 10,					-- Number of personalities that can be gained except the one you get when turning 15.
	...
	MONTHS_TO_CORE_MINIMUM = 0,						-- Minimum amount of months it will take to core a province after all modifiers.
	...
	DICTATORSHIP_TRADITION_FOR_MONARCHY = 1,		-- If republican tradition is lower than this on death of ruler, dictatorship turns into monarchy
...
NEconomy = {
	...
	GOLD_MINE_SIZE = 80,							-- Base income from gold mines
	...
	GOLD_INFLATION = 2.0,							-- _EDEF_GOLD_INFLATION_
	TREASURE_FLEET_INFLATION = 0.5,
	BASE_YEARLY_INFLATION = 0,					-- yearly inflation increase
	INFLATION_FROM_LOAN = 0.1,						-- increase per loan
	INFLATION_FROM_PEACE_GOLD = 0,				-- inflation per month of income taken in peace (also applied to province sales)
	...
	MERCHANT_SPEED = 60.0,							-- MERCHANT_SPEED
...
NMilitary = {
	...
	LEADER_MAX_PIPS = 25,								-- Max general/admiral pips (per skill)
...
NReligion = {
	...
	MAX_CARDINALS = 490000,											-- Max amount of cardinals
	MAX_CARDINALS_PER_COUNTRY = 700,								-- Max cardinals in a single country
...
NNationDesigner = {
	...
	IDEAS_PERCENTAGE_LIMIT = 100,			-- Max % from any one category to not get overstacking penalty
	...
	MAX_DISTANCE_TO_OWNER_AREA = 40000,
	MAX_DISCOVERED_PROVINCE_DISTANCE = 50000,
